                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="pl-5 pr-5 pb-5 ">
                                ...
                                <a href="<?= base_url('Input/tambahDataR2') ?>" class="btn bg-secondary btn-block text-white text-uppercase rounded-pill">
                                    <i class="fas fa-fw fa-motorcycle mr-2"></i>
                                    input tnkb roda dua
                                </a>
                                <a href="<?= base_url('Input/tambahDataR4') ?>" class="btn bg-secondary btn-block text-white text-uppercase rounded-pill">
